...
var grammar = {
    ...
    {"name": "term", "symbols": ["term", (lexer.has("times") ? {type: "times"} : times), (lexer.has("number") ? {type: "number"} : number)], "postprocess": ([fst, , snd]) => fst * snd},
    {"name": "term", "symbols": ["term", (lexer.has("over") ? {type: "over"} : over), (lexer.has("number") ? {type: "number"} : number)], "postprocess": ([fst, , snd]) => fst / snd},
    {"name": "term", "symbols": ["term", (lexer.has("wholeOver") ? {type: "wholeOver"} : wholeOver), (lexer.has("number") ? {type: "number"} : number)], "postprocess": ([fst, , snd]) => fst // snd},
