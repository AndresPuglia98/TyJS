...
var grammar = {
    ...
    {"name": "type", "symbols": [(lexer.has("lsqBracket") ? {type: "lsqBracket"} : lsqBracket), "itParams", (lexer.has("rsqBracket") ? {type: "rsqBracket"} : rsqBracket)], "postprocess": ([,params,]) => typeObjects.typeIterable(params)},
    ...
    {"name": "itType", "symbols": [(lexer.has("dots") ? {type: "dots"} : dots), (lexer.has("positiveInt") ? {type: "positiveInt"} : positiveInt), "_", (lexer.has("times") ? {type: "times"} : times), "_", "type"], "postprocess": ([,n,,,,type]) => Array(n).fill(typeObjects.typeSingleItElement(type))},
