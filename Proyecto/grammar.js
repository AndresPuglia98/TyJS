...
var grammar = {
    ...
    {"name": "pl", "symbols": ["prop", "_", (lexer.has("comma") ? {type: "comma"} : comma), "_", "p"], "postprocess": ([fst,,,,m]) => fst.concat(m)},
    ...
    {"name": "objProp", "symbols": [(lexer.has("identifier") ? {type: "identifier"} : identifier), "_", (lexer.has("colon") ? {type: "colon"} : colon), "_", "type"], "postprocess": ([key,,,,type]) => typeObjects.typeNameProp(key, type)},
    {"name": "objProp", "symbols": [(lexer.has("regex") ? {type: "regex"} : regex), "_", (lexer.has("colon") ? {type: "colon"} : colon), "_", "type"], "postprocess": ([key,,,,type]) => typeObjects.typeRegexProp(key, type)},
