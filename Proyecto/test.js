...
console.log(tipo1);
console.log(tipo1.checks(3) === true);
console.log(tipo1.checks(4) === false);
console.log(tipo1.checks('3') === false);

const tipo2 = new Type('in [23, "abc", false]', [isPrime]);
console.log(tipo2);
console.log(tipo2.checks(23) === true);
console.log(tipo2.checks('abc') === true);
console.log(tipo2.checks(true) === false);
console.log(tipo2.checks(45) === false);
console.log(tipo2.checks(false) === true);

const tipo3 = new Type('char | byte');
console.log(tipo3);
console.log(tipo3.checks('a') === true);
console.log(tipo3.checks('abc') === false);
console.log(tipo3.checks(3456) === false);
console.log(tipo3.checks(45) === true);

const tipo4 = new Type('number & /^\\d{3}$/'); // preguntar esto
console.log(tipo4);
console.log(tipo4.checks('345') === false);
console.log(tipo4.checks(345) === true);
console.log(tipo4.checks(3456) === false);

const tipo5 = new Type('int');
console.log(tipo5);
console.log(tipo5.checks('345') === false);
console.log(tipo5.checks(345) === true);
console.log(tipo5.checks(3.14) === false);

const tipo6 = new Type('double');
console.log(tipo6);
console.log(tipo6.checks('345') === false);
console.log(tipo6.checks(345) === false);
console.log(tipo6.checks(3.14) === true);
console.log(tipo6.checks(NaN) === true);
console.log(tipo6.checks(Infinity) === true);
console.log(tipo6.checks(3e-6) === true);
